...
namespace eskf{
  ...
  public:
    static const int k_num_states_ = 22;
  ...
  //  void controlMagFusion();
    ...
    //const scalar_t gyro_noise_ {0};	///< IMU angular rate noise used for covariance prediction (rad/sec)///
    const scalar_t accel_noise_ {3.5e-1};	///< IMU acceleration noise use for covariance prediction (m/sec**2)
    //const scalar_t accel_noise_ {3.5e-3};	///< IMU acceleration noise use for covariance prediction (m/sec**2)////
