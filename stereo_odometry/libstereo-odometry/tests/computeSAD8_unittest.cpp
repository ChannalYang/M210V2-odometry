...
TEST(SAD_Tests,computeSAD8)
{
	...
	//cout<<"dizhi" <<RSO_GLOBAL_UNITTEST_SRC_DIR<<endl;
	if ( !imgL.loadFromFile("/home/qin/文档/stereo-vo-master/libstereo-odometry/tests/0L.png") ) FAIL() << "Couldn't load test imageL!";
	if ( !imgR.loadFromFile("/home/qin/文档/stereo-vo-master/libstereo-odometry/tests/0R.png") ) FAIL() << "Couldn't load test imageR!";
